Iconos
El framework MOVA acepta las siguientes familias de iconos:
...
La lista de iconos disponibles de Material se puede consultar en https://material.io/resources/icons/?style=baseline
...
Ejemplos de iconos de Material:

warningassignmentbookbookmarkbuilddonebackupexplorefingerprintinfolabellock_open
Font Awesome
code

La lista de iconos disponibles de Font Awesome se puede consultar en https://fontawesome.com/icons?d=gallery&m=free
