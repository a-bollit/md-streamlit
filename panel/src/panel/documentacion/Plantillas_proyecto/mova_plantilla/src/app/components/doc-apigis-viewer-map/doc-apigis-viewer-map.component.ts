...
@Component({
  selector: "app-doc-apigis-viewer-map",
  templateUrl: "./doc-apigis-viewer-map.html",
  styleUrls: ["./doc-apigis-viewer-map.scss"],
})
export class DocApigisViewerMap implements OnInit {
  constructor() {}
