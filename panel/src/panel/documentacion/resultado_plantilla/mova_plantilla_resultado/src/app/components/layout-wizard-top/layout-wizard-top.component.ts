...
@Component({
  selector: 'app-layout-wizard-top',
  templateUrl: './layout-wizard-top.html',
  styleUrls: ['./layout-wizard-top.scss'],
})
export class LayoutWizardTop implements OnInit {
  activeStep = 1;
