...
@Component({
  selector: 'app-doc-footer-nav-tab-example3',
  templateUrl: './doc-footer-nav-tab-example3.html',
  styleUrls: ['./doc-footer-nav-tab-example3.scss'],
})
export class DocFooterNavTabExample3 implements OnInit {
