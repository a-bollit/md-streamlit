...
@Component({
  selector: 'app-forms-reactive-validation',
  templateUrl: './forms-reactive-validation.html',
  styleUrls: ['./forms-reactive-validation.scss'],
})
export class FormsReactiveValidation implements OnInit {
  centros: any[] = [
    {
      id: 1,
