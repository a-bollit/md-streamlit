...
@Component({
  selector: 'app-forms-template-validation',
  templateUrl: './forms-template-validation.html',
  styleUrls: ['./forms-template-validation.scss'],
})
export class FormsTemplateValidation implements OnInit {
