...
@Component({
  selector: 'app-doc-footer-nav-tab-example4',
  templateUrl: './doc-footer-nav-tab-example4.html',
  styleUrls: ['./doc-footer-nav-tab-example4.scss'],
})
export class DocFooterNavTabExample4 implements OnInit {
