...
@Component({
  selector: "app-doc-apigis-image",
  templateUrl: "./doc-apigis-image.html",
  styleUrls: ["./doc-apigis-image.scss"],
})
export class DocApigisImage implements OnInit {
  constructor() {}
  ...
  ngOnInit(): void {
    ...
    const viewer = new ApiViewer({
      container: "doc-apigis-image-container",
      options: {
        projections: {
          "EPSG:25830":
...
ngOnInit() {
  // Generación de una capa de tipo Image/Image
